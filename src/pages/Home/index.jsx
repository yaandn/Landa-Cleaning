  ...
  return (
    <>
      ...
      <section className="home-container" id="home">
        <div className="box-quadrado">
          <span className="descricao">
            Let us take care of cleaning{" "}
            <span className="texto-destaque">YOUR HOME</span> and ensuring your
            family's health.
          </span>
          ...
          <div className="cards-container">
            <div className="card">
              ...
              <span className="texto-card">
                ...
                exteriors, with extra attention to bathrooms. Recommended
                especially for those who clean only every few months.
              </span>
            </div>
            <div className="card">
              <div className="imagem-card"></div>
              ...
              <span className="texto-card">
                ...
                Maintenance Cleaning. We cover all essential sections of your
                residence, encompassing dusting, sanitizing, vacuuming, and
                floor cleansing. If desired, we can even arrange fresh bed
        ...
        <div className="box-quadrado-servicos">
          <div className="lado-esquerdo">
            <span className="texto-terciario">
              ...
              haven for you to enjoy special moments and relax with tranquility.
              Discover the transformative power of Radiant Residential Cleaning
              today!
            </span>
      ...
      <section className="sobrenos-container" id="sobrenos">
        <div className="conteudo">
          ...
          <span className="texto-sobrenos">
            A professional cleaning company committed to delivering
            comprehensive hygiene and organization solutions for homes and
            commercial spaces. Our highly trained team and modern equipment
            ensure impeccable environments, promoting comfort and well-being.
            After the pandemic we make sure that we clean and sanitize your
            place.. Let us take care of the cleaning, allowing you to enjoy a
      ...
      <section className="contato-container" id="contato">
        <div className="mapa">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2684.1965313208752!2d-122.1773242!3d47.71943460000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x549013cd11a53d1f%3A0x66fd72362a8f0e35!2sLanda%20Cleaning%20Services!5e0!3m2!1spt-BR!2sbr!4v1691688744328!5m2!1spt-BR!2sbr"
            width="70%"
            height="100%"
            allowfullscreen=""
            loading="lazy"
        ...
        <div className="informacoes">
          ...
          <div className="box-informacoes">
            ...
            <div className="box-botao-informacoes">
              <a
                href="https://www.google.com/maps/dir//Landa+Cleaning+Services/data=!4m8!4m7!1m0!1m5!1m1!1s0x549013cd11a53d1f:0x66fd72362a8f0e35!2m2!1d-122.1773242!2d47.7194346"
                target="_blank"
              >
            ...
            <span className="descricao-informacoes">
              13314 122nd Place Northeast Kirkland, WA 98034 USA
            </span>
          </div>
          ...
          <div className="box-informacoes">
            ...
            <ul className="lista-horarios">
              <li className="lista-horarios-itens">
                Monday: 7:00 AM – 6:00 PM
              </li>
              <li className="lista-horarios-itens">
                Tueday: 7:00 AM – 6:00 PM
              </li>
              <li className="lista-horarios-itens">
      ...
      <section className="avaliacoes-container" id="avaliacoes">
        <span className="titulo-avaliacoes">
        ...
        <div className="container-avaliacoes">
          <div className="box-avaliacoes">
            ...
            <span className="texto-avaliacao">
              The team has been cleaning our house every other week for over a
              year. They do a really great job. They pay attention to the
              details, they don't complain about the legos (we have 3 kids) or
              how it always takes us 10 minutes to fully get out of the way,
              they make the beds and fold the towels nicely. They wipe
              everything down and mop and vacuum. They leave our backdoor
              windows without handprints. They take the trash and recycling out
              and wipe down the outside of the kitchen cabinets and trash.
              Honestly, it's really a good clean, and they're very efficient.
              What I've appreciated the most is the easy communication, being
              timely and easy to coordinate with. There's no drama. They don't
              need oversight. They're understanding when the occasional
              scheduling conflict comes up for us. Day to day, they're always
              friendly and smiling and trustworthy. We've met a few of their
              team over the 1.5 years, and really everyone is kind and good.
              It's never awkward if we need to be around the house or...
            </span>
          ...
          <div className="box-avaliacoes">
            ...
            <span className="texto-avaliacao">
              TI easily give Wilma and her team 5 stars, they were all
              professional and also personable and did a great job of deep
              cleaning my apartment for my move out … I highly recommend Landa
              Cleaning Services … nice to support locally owned businesses in
              the area. I am letting everyone I know in the area about this gem
              of a company!
            </span>
            <div className="nome-container">
              <span>- Nancy H</span>
            ...
            <div className="box-botao-avaliacoes">
              <a
                href="https://www.google.com/search?hl=pt-BR&gl=br&q=Landa+Cleaning+Services,+13314+122nd+Pl+NE,+Kirkland,+WA+98034,+Estados+Unidos&ludocid=7421213337944264245&lsig=AB86z5U2maG0bWajCIISv5cmhjwD#lrd=0x549013cd11a53d1f:0x66fd72362a8f0e35,1"
                target="_blank"
              >
          ...
          <div className="box-avaliacoes">
            ...
            <span className="texto-avaliacao">
              Wilma is wonderful to work with. She is trustworthy and very
              communicative . She is open to suggestions and will accommodate my
              requests happily. She has been cleaning my home for almost 2 years
              now. I am happy with her work. The Landa Cleaning team does a
              fantastic job. I highly recommend them.
            </span>
            <div className="nome-container">
